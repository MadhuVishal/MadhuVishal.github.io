...
<th class="cell100 column5">Small</th>
<th class="cell100 column5">Medium</th>
<th class="cell100 column5">Large</th>
<th class="cell100 column5">Combo</th>
<th class="cell100 column5">Half-yearly</th>
<th class="cell100 column5">yearly</th>
...
<td class="cell100 column4"><?php echo $nt2['address']; ?></td>
<td class="cell100 column4"><?php echo $nt2['small']; ?></td>
<td class="cell100 column4"><?php echo $nt2['medium']; ?></td>
<td class="cell100 column4"><?php echo $nt2['large']; ?></td>
<td class="cell100 column4"><?php echo $nt2['combo_pads']; ?></td>
<td class="cell100 column4"><?php echo $nt2['half_yearly_pack']; ?></td>
<td class="cell100 column4"><?php echo $nt2['yearly_pack']; ?></td>
...
<button type="button" class="btn btn-primary" style="" onclick="del_order()">DELETE RECORDS</button>	
<!-- <button type="button" class="btn btn-primary" style="" onclick="export_xls()">EXPORT RECORDS</button>	 -->
...
<script src="./table_files/js/export.js"></script>
</body>
